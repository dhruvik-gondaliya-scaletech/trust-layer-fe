      ...
      <div className="flex flex-col min-h-dvh justify-between p-6">
        ...
        <div className="flex-1 flex flex-col justify-center items-center py-12">
          <div className="w-full max-w-sm bg-white rounded-3xl p-8 shadow-sm border border-slate-100/80 flex flex-col items-center text-center relative overflow-hidden">
            ...
            {/* Huge 404 Indicator */}
            <span className="text-[64px] font-black tracking-tight leading-none bg-gradient-to-b from-primary to-blue-700 bg-clip-text text-transparent select-none filter drop-shadow-sm">
              404
            </span>

            {/* Title */}
            <h1 className="text-xl font-bold text-slate-900 tracking-tight mt-2 mb-2">
              Way Off Course
            </h1>
