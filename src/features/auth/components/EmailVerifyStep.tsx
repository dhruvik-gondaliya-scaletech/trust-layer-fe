      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8 gap-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-primary/5 flex items-center justify-center border border-primary/10">
            <Mail className="w-7 h-7 text-primary stroke-[1.5]" />
          </div>
        ...
        >
          ...
          <div className="flex flex-col gap-2.5">
            <Label className="text-xs font-bold text-foreground/80 max-w-sm mx-auto w-full px-1">
              6-Digit Code
            </Label>
          ...
          {/* Shield Informational Box */}
          <div className="p-4 bg-primary/5 border border-primary/10 rounded-2xl flex gap-3 text-left max-w-md mx-auto">
            <Shield className="w-5 h-5 text-primary stroke-[2] shrink-0 mt-0.5" />
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold text-foreground">
                Why verify your email?
              </span>
              <p className="text-[11px] leading-relaxed text-muted-foreground">
                We need to confirm your email so we can send important escrow
                and shipping updates securely.
              </p>
            </div>
          </div>
