        ...
        <div className="bg-white rounded-[24px] p-5 shadow-xl shadow-blue-900/5 border border-gray-100 space-y-6">
            ...
            <div className="flex justify-center gap-2 max-w-xs flex-wrap">
              {AVATAR_OPTIONS.map((avatar) => (
                <button
                  ...
                  className={cn("w-9 h-9 rounded-xl flex items-center justify-center text-lg border transition-all hover:scale-105 active:scale-95",
          ...
          <form id="profile-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left" noValidate>
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="profile-username" className="text-[13px] font-bold text-foreground ml-1">Username</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn("pl-8 h-14 text-[16px] font-bold bg-gray-50/50 border-gray-200 focus-visible:ring-primary/20",
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="profile-bio" className="text-[13px] font-bold text-foreground ml-1">Short Bio (Optional)</Label>
              <Textarea
                id="profile-bio"
                disabled={isPending}
                placeholder="Tell us a little bit about yourself..."
                rows={3}
                className={cn("text-[16px] font-medium bg-gray-50/50 border-gray-200 focus-visible:ring-primary/20 rounded-2xl p-4 min-h-[100px]",
                  errors.bio ? "border-destructive focus-visible:ring-destructive/20" : ""
                )}
                {...register("bio")}
              />
              {errors.bio && (
