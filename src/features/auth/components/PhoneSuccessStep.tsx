...
import { Smartphone, CheckCircle2, Circle } from "lucide-react";
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <div className="w-20 h-20 rounded-full bg-emerald-500/5 flex items-center justify-center border border-emerald-500/15">
              <Smartphone className="w-9 h-9 text-emerald-500 stroke-[1.5]" />
            </div>
          ...
          <div className="text-center flex flex-col gap-2">
            ...
            <span className="text-sm font-bold text-primary">{phoneNumber}</span>
