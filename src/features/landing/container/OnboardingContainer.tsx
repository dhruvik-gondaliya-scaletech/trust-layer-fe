...
export const OnboardingContainer: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-dvh bg-background flex items-center justify-center p-0 sm:p-4">
      ...
      <div className="w-full sm:max-w-[440px] bg-card sm:rounded-[2.5rem] sm:shadow-2xl sm:border sm:border-border/40 overflow-y-auto flex flex-col min-h-dvh sm:min-h-[840px] max-h-dvh sm:max-h-[840px] relative scrollbar-none">
        <AnimatePresence mode="wait">
          {view === "landing" ? (
            ...
            >
              {/* Landing Hero Area */}
              <div className="bg-primary pt-12 pb-10 px-6 rounded-b-[2.5rem] text-center flex flex-col items-center gap-6 shadow-md shadow-primary/10">
            ...
            <motion.div
              ...
              exit="exit"
              variants={fadeIn}
              className="flex-1 flex flex-col min-h-dvh sm:min-h-[840px] justify-between relative"
            >
              {/* Header Bar */}
